    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Skill 不存在</p>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
              ...
              <div className="flex flex-wrap gap-4 text-sm text-gray-500 dark:text-gray-400 mb-4">
                <span className="flex items-center gap-1">
                  ⭐ {skill.rating.toFixed(1)} ({skill.ratingCount} 评价)
                </span>
                <span className="flex items-center gap-1">
                  📥 {skill.installCount.toLocaleString()} 安装
                </span>
                <span className="flex items-center gap-1">
                  📅 更新于 {skill.updatedAt}
                </span>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
              ...
              <ol className="space-y-3 text-gray-600 dark:text-gray-400">
                ...
                <li className="flex gap-3">
                  ...
                  <span>打开你的 OpenClaw Agent（Telegram/Discord/Web）</span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span>粘贴并发送命令，Agent 会自动学习该 Skill</span>
                </li>
                <li className="flex gap-3">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Links */}
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-4">相关链接</h3>
