...
export function Header() {
  ...
  return (
    <header className="bg-[#13131a]/80 backdrop-blur-xl border-b border-[#2d2d3a] sticky top-0 z-50">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden border-t border-[#2d2d3a] bg-[#13131a] px-6 py-4 space-y-4">
          <Link 
            href="/skills" 
